 ...
 */
declare function expressStaticGzip(root: string, uncompressedRoot : string, options: expressStaticGzip.ExpressStaticGzipOptions): (req: any, res: any, next: any) => any;
